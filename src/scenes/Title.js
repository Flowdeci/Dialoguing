class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('homer akatstki', 'img/homer akatstki.png')
    ...
    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'fresh_font', 'THE ODYSSEY', 64).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY+32, 'fresh_font', 'Press SPACE to start', 32).setOrigin(0.5)
